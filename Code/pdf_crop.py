...
"""
Source: http://www.mobileread.com/forums/showthread.php?t=25565

The script is supposed to be run like this:
pdf_crop.py" -m "120 50 120 180" -i mypdf.pdf
where the margins are left top right bottom (how much you cut from each side.
"""
import getopt, sys
...
top_right = {'x': input1.getPage(0).mediaBox.getUpperRight_x(), 'y': input1.getPage(0).mediaBox.getUpperRight_y()}
top_left = {'x': input1.getPage(0).mediaBox.getUpperLeft_x(), 'y': input1.getPage(0).mediaBox.getUpperLeft_y()}
bottom_right = {'x': input1.getPage(0).mediaBox.getLowerRight_x(), 'y': input1.getPage(0).mediaBox.getLowerRight_y()}
bottom_left = {'x': input1.getPage(0).mediaBox.getLowerLeft_x(), 'y': input1.getPage(0).mediaBox.getLowerLeft_y()}
